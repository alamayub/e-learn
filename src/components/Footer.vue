    ...
    <v-container class="footer">
      <div class="company">
        <div class="logo font-weight-bold title">
          <span class="primary--text">e</span><span>-learn</span>
        </div>   
        <div class="mt-3 mb-4 para">Top instructor from around the world teach millions of student.</div>
        <div>
          <div class="title mb-2">Subcriber Newsletter</div>
          <div class="email__input" style="position: relative;">
            <v-btn width="30" height="30" tile icon class="secondary send__btn">
      ...
      <div class="footer__links">
        ...
        <div class="links">
          ...
          <div class="socials mt-4">
            ...
            <v-btn icon small v-for="(social, s) in socials" :key="s" color="black" target="_blank" :href="social.to">
